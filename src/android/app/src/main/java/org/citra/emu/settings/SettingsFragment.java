...
public final class SettingsFragment extends Fragment {
    ...
    private ArrayList<SettingsItem> loadSettingsList() {
        ...
        Setting separableShader = debugSection.getSetting(SettingsFile.KEY_USE_SEPARABLE_SHADER);
        ...
        sl.add(new CheckBoxSetting(SettingsFile.KEY_SHADERS_ACCURATE_MUL,
                                   ...
                                   R.string.setting_shaders_accurate_mul, R.string.setting_shaders_accurate_mul_desc, false, accurateMul));
        ...
        sl.add(new CheckBoxSetting(SettingsFile.KEY_USE_SEPARABLE_SHADER, Settings.SECTION_INI_DEBUG,
                R.string.setting_use_separable_shader, R.string.setting_use_separable_shader_desc, false, separableShader));
