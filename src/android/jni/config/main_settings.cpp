...
const ConfigInfo<std::string> CIRCLE_PAD_UP{{"Controls", "circle_pad_up"}, "code:17"};
const ConfigInfo<std::string> CIRCLE_PAD_DOWN{{"Controls", "circle_pad_down"}, "code:18"};
const ConfigInfo<std::string> CIRCLE_PAD_LEFT{{"Controls", "circle_pad_left"}, "code:19"};
const ConfigInfo<std::string> CIRCLE_PAD_RIGHT{{"Controls", "circle_pad_right"}, "code:20"};
const ConfigInfo<std::string> C_STICK_UP{{"Controls", "c_stick_up"}, "code:21"};
const ConfigInfo<std::string> C_STICK_DOWN{{"Controls", "c_stick_down"}, "code:22"};
const ConfigInfo<std::string> C_STICK_LEFT{{"Controls", "c_stick_left"}, "code:23"};
const ConfigInfo<std::string> C_STICK_RIGHT{{"Controls", "c_stick_right"}, "code:24"};
