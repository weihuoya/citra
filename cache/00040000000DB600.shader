...
// reference: A31B0E99B80ADCC7, C3B5579D93C65082
// program: 4940142D60DA9543, 5D764F9A6220D694, C3B5579D93C65082
...
// reference: 23974C64B97E2F6C, 2B811601C66B2B58
...
vec3 color_output_1 = byteround(clamp((last_tex_env_out.rgb) + (texcolor1.rgb) - vec3(0.5), vec3(0.0), vec3(1.0)));
...
// reference: 161FD6AAEC2C7323, FA469CE8A8D3E41A
// program: 2B811601C66B2B58, AD7922A63ED54CA7, FA469CE8A8D3E41A
// reference: 9FA96BF997464DA4, 2B811601C66B2B58
// shader: 8B30, 133B65DD28A9342F
...
refl_value.b = refl_value.r;
diffuse_sum.rgb += ((light_src[0].diffuse * dot_product) + light_src[0].ambient) * LookupLightingLUTUnsigned(16,clamp(light_src[0].dist_atten_scale * length(-view - light_src[0].position) + light_src[0].dist_atten_bias, 0.0, 1.0)) * 1.0;
specular_sum.rgb += (((lut_scale_d0 * LookupLightingLUTUnsigned(0, abs(dot(normal, normalize(half_vector))))) * light_src[0].specular_0) + (light_src[0].specular_1)) * clamp_highlights * LookupLightingLUTUnsigned(16,clamp(light_src[0].dist_atten_scale * length(-view - light_src[0].position) + light_src[0].dist_atten_bias, 0.0, 1.0)) * 1.0;
diffuse_sum.rgb += lighting_global_ambient;
primary_fragment_color = clamp(diffuse_sum, vec4(0.0), vec4(1.0));
secondary_fragment_color = clamp(specular_sum, vec4(0.0), vec4(1.0));
...
// reference: 69B0AF93B6F0D597, 133B65DD28A9342F
// program: 2B811601C66B2B58, AD7922A63ED54CA7, 133B65DD28A9342F
// shader: 8B30, 44CBA152B204BF9C
...
vec3 color_output_1 = byteround(clamp((vec3(1.0) - texcolor1.aaa) - (vec3(1.0) - const_color[1].rgb), vec3(0.0), vec3(1.0)));
...
// reference: 0A2505408D965D00, 44CBA152B204BF9C
// program: 2B811601C66B2B58, AD7922A63ED54CA7, 44CBA152B204BF9C
// reference: ADBEE1CBECDEDCDD, 4940142D60DA9543
// shader: 8B30, A23A66CFBBC7A774
...
vec3 color_output_1 = byteround(clamp((texcolor2.rgb) * (const_color[1].ggg) + (last_tex_env_out.rgb) * (vec3(1.0) - (const_color[1].ggg)), vec3(0.0), vec3(1.0)));
float alpha_output_1 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_1, alpha_output_1), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_2 = byteround(clamp((last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_2 = byteround(clamp((last_tex_env_out.r) * (const_color[2].r) + (last_tex_env_out.b) * (1.0 - (const_color[2].r)), 0.0, 1.0));
...
float alpha_output_3 = byteround(clamp((last_tex_env_out.g) * (const_color[3].g) + (last_tex_env_out.a) * (1.0 - (const_color[3].g)), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_3, alpha_output_3), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
float alpha_output_5 = byteround(clamp((last_tex_env_out.a) * (const_color[5].a) + (last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_5 * 1.0, alpha_output_5 * 2.0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

gl_FragDepth = depth;
color = byteround(last_tex_env_out);
}
// reference: 8DDE7284D13C8C47, A23A66CFBBC7A774
// program: 4940142D60DA9543, 5D764F9A6220D694, A23A66CFBBC7A774
// reference: 1180C656C2E6BE15, 4940142D60DA9543
// shader: 8B30, 51588320CE29EE7E
...
vec3 color_output_4 = byteround(clamp((texcolor2.rgb) * (const_color[4].rgb) + (texcolor1.rgb) * (vec3(1.0) - (const_color[4].rgb)), vec3(0.0), vec3(1.0)));
float alpha_output_4 = byteround(clamp((texcolor2.a) * (const_color[4].a) + (texcolor1.a) * (1.0 - (const_color[4].a)), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_4, alpha_output_4), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_5 = byteround(clamp((last_tex_env_out.rgb) * (const_color[5].rgb) + (texcolor0.rgb) * (vec3(1.0) - (const_color[5].rgb)), vec3(0.0), vec3(1.0)));
float alpha_output_5 = byteround(clamp((last_tex_env_out.a) * (const_color[5].a) + (texcolor0.a) * (1.0 - (const_color[5].a)), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_5, alpha_output_5), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: CB33E90832DCEDF7, 51588320CE29EE7E
// program: 4940142D60DA9543, 5D764F9A6220D694, 51588320CE29EE7E
// shader: 8B30, 5899F6336F3FF725
...
vec3 color_output_3 = byteround(clamp((texcolor2.rgb) * (const_color[3].rgb) + (texcolor1.rgb) * (vec3(1.0) - (const_color[3].rgb)), vec3(0.0), vec3(1.0)));
float alpha_output_3 = byteround(clamp((const_color[3].a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_3, alpha_output_3), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_4 = byteround(clamp((last_tex_env_out.rgb) * (const_color[4].rgb) + (texcolor0.rgb) * (vec3(1.0) - (const_color[4].rgb)), vec3(0.0), vec3(1.0)));
...
// reference: DE161AFF29DD60B9, 5899F6336F3FF725
// program: 4940142D60DA9543, 5D764F9A6220D694, 5899F6336F3FF725
// shader: 8B30, B4A8F1E60F921DD9
...
// reference: BE098C00ED949627, B4A8F1E60F921DD9
// program: 4940142D60DA9543, 5D764F9A6220D694, B4A8F1E60F921DD9
// shader: 8B30, 1C390106A2FE1B30
...
// reference: BE098C0074D0275E, 1C390106A2FE1B30
// program: 4940142D60DA9543, 5D764F9A6220D694, 1C390106A2FE1B30
// shader: 8B30, 4CCAD2728C2FBA9C
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp((texcolor0.rgb) * (const_color[0].ggg) + (const_color[0].rrr) * (vec3(1.0) - (const_color[0].ggg)), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp((texcolor0.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_0, alpha_output_0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
float alpha_output_1 = byteround(clamp((last_tex_env_out.r) * (const_color[1].a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_1, alpha_output_1), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_2 = byteround(clamp((combiner_buffer.ggg) * (const_color[2].rgb) + (last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_2 = byteround(clamp((combiner_buffer.g) * (const_color[2].a) + (last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_2, alpha_output_2), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_3 = byteround(clamp((combiner_buffer.bbb) * (const_color[3].rgb) + (last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_3 = byteround(clamp((combiner_buffer.b) * (const_color[3].a) + (last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_3, alpha_output_3), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_4 = byteround(clamp((last_tex_env_out.rgb) * (const_color[4].bbb) + (last_tex_env_out.aaa) * (vec3(1.0) - (const_color[4].bbb)), vec3(0.0), vec3(1.0)));
float alpha_output_4 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_4, alpha_output_4), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_5 = byteround(clamp((last_tex_env_out.rgb) * (const_color[5].aaa) + (last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_5 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_5, alpha_output_5), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 55F0DE251D722B68, 4CCAD2728C2FBA9C
// program: 4940142D60DA9543, 5D764F9A6220D694, 4CCAD2728C2FBA9C
// shader: 8B30, D41092D3ABEC8672
...
// reference: 801566490409E262, D41092D3ABEC8672
// program: 4940142D60DA9543, 5D764F9A6220D694, D41092D3ABEC8672
// reference: 161FD6AAEDEE1914, FA469CE8A8D3E41A
// reference: 69B0AF93B732BFA0, 133B65DD28A9342F
// reference: 0A2505408C543737, 44CBA152B204BF9C
// shader: 8B30, 140C00CC72F591C3
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp((rounded_primary_color.rgb) * (rounded_primary_color.aaa), vec3(0.0), vec3(1.0)));
...
float alpha_output_1 = byteround(clamp((last_tex_env_out.a) * (const_color[1].r) + (last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_1, alpha_output_1), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_2 = byteround(clamp((last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_2 = byteround(clamp((last_tex_env_out.a) * (const_color[2].r) + (last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_2, alpha_output_2), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_3 = byteround(clamp((last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_3 = byteround(clamp((last_tex_env_out.a) * (const_color[3].r) + (last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_3, alpha_output_3), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_4 = byteround(clamp((last_tex_env_out.rgb) * (rounded_primary_color.aaa), vec3(0.0), vec3(1.0)));
float alpha_output_4 = byteround(clamp((last_tex_env_out.a) * (const_color[4].r) + (last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_4, alpha_output_4), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_5 = byteround(clamp((last_tex_env_out.rgb) * (texcolor0.aaa), vec3(0.0), vec3(1.0)));
...
// reference: A58114DFA86DB58E, 140C00CC72F591C3
// program: 4940142D60DA9543, 5D764F9A6220D694, 140C00CC72F591C3
// shader: 8B30, E2AC13FB8C1285AB
...
// reference: 5C6AD439394C369C, E2AC13FB8C1285AB
// program: 4940142D60DA9543, 5D764F9A6220D694, E2AC13FB8C1285AB
// shader: 8B30, 205E7838E6DB6C1B
...
// reference: E080DE97B8B32026, 205E7838E6DB6C1B
// program: 4940142D60DA9543, 5D764F9A6220D694, 205E7838E6DB6C1B
// shader: 8B30, DE18545631F80EEA
...
// reference: D1D7D6277248F6D5, DE18545631F80EEA
// program: 4940142D60DA9543, 5D764F9A6220D694, DE18545631F80EEA
// shader: 8B30, 329451570DB42B21
...
// reference: 924C062972F10A34, 329451570DB42B21
// program: 4940142D60DA9543, 5D764F9A6220D694, 329451570DB42B21
// shader: 8B30, 27715F070BC57A50
...
// reference: CDBC328F5E726D52, 27715F070BC57A50
// program: 2B811601C66B2B58, AD7922A63ED54CA7, 27715F070BC57A50
...
// program: 2B811601C66B2B58, AD7922A63ED54CA7, FB4E9E925D4DB26E
// shader: 8B31, 6F634015D249EEB0
...
// reference: A89DFED5A186B117, 6F634015D249EEB0
...
// reference: 6CC0BC6B5F4552A4, E4D8B14C4E69482A
// program: 6F634015D249EEB0, 4BD70AD09292A3DA, E4D8B14C4E69482A
// program: 2B811601C66B2B58, AD7922A63ED54CA7, E4D8B14C4E69482A
// shader: 8B31, 94443491BD025A47
...
// reference: 078F3942D67B559D, 94443491BD025A47
...
// reference: 6CC0BC6B1254EF14, 46E7802B12D25D25
// program: 94443491BD025A47, 0282066502FA87A6, 46E7802B12D25D25
// shader: 8B30, 72F3603E3ADBE55F
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp((texcolor0.rgb) * (vec3(1.0) - texcolor2.aaa) + (texcolor2.rgb) * (vec3(1.0) - (vec3(1.0) - texcolor2.aaa)), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp((rounded_primary_color.a) * (texcolor0.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_0, alpha_output_0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
vec3 color_output_2 = byteround(clamp((last_tex_env_out.rgb) + (texcolor1.rgb) - vec3(0.5), vec3(0.0), vec3(1.0)));
...
// reference: 3F133093E4EB3A87, 72F3603E3ADBE55F
// program: 2B811601C66B2B58, AD7922A63ED54CA7, 72F3603E3ADBE55F
// reference: 9FA96BF94CFFECE3, 2B811601C66B2B58
// shader: 8B30, 19D8B2D20403BD0E
...
// reference: DBD770BEEC2C7323, 19D8B2D20403BD0E
// program: 2B811601C66B2B58, AD7922A63ED54CA7, 19D8B2D20403BD0E
// shader: 8B30, 0E6A72BBF9CC887D
...
// reference: 21D0662CAD605D78, 0E6A72BBF9CC887D
// program: 4940142D60DA9543, 5D764F9A6220D694, 0E6A72BBF9CC887D
// shader: 8B30, 0464A47BB903FD8E
...
vec3 color_output_5 = byteround(clamp((last_tex_env_out.rgb) * (vec3(1.0) - texcolor0.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_5 = byteround(clamp((1.0 - last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_5, alpha_output_5), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: A88FA311093DB477, 0464A47BB903FD8E
// program: 4940142D60DA9543, 5D764F9A6220D694, 0464A47BB903FD8E
// shader: 8B30, 0BE916DA02E653B2
...
// reference: 96C8629EE430B0E7, 0BE916DA02E653B2
// program: 4940142D60DA9543, 5D764F9A6220D694, 0BE916DA02E653B2
// shader: 8B30, 89240B24E91EA7ED
...
vec3 color_output_5 = byteround(clamp((texcolor0.rgb) * (rounded_primary_color.aaa), vec3(0.0), vec3(1.0)));
float alpha_output_5 = byteround(clamp((const_color[5].a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_5, alpha_output_5), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: CC72F2CD97422FAA, 89240B24E91EA7ED
// program: 4940142D60DA9543, 5D764F9A6220D694, 89240B24E91EA7ED
// shader: 8B30, D732EAEAB0845BCF
...
vec3 color_output_4 = byteround(clamp((texcolor0.rgb) * (texcolor0.aaa), vec3(0.0), vec3(1.0)));
...
// reference: 81F145EEAF4B4AA2, D732EAEAB0845BCF
// program: 4940142D60DA9543, 5D764F9A6220D694, D732EAEAB0845BCF
...
// reference: 9D3A6C822C9F4BC2, 241CC95D49600A0B
// program: 4940142D60DA9543, 5D764F9A6220D694, 241CC95D49600A0B
// shader: 8B30, 34CAF04528BFB045
...
// reference: 2EA60C87BDF69594, 34CAF04528BFB045
// program: 4940142D60DA9543, 5D764F9A6220D694, 34CAF04528BFB045
// shader: 8B30, 10C01377669A8ACA
...
// reference: 367C5E3CD663BD78, 10C01377669A8ACA
// program: 2B811601C66B2B58, AD7922A63ED54CA7, 10C01377669A8ACA
// shader: 8B30, C60EEB6E4E6A9210
...
// reference: 3F133093085CD184, C60EEB6E4E6A9210
// program: 2B811601C66B2B58, AD7922A63ED54CA7, C60EEB6E4E6A9210
// shader: 8B30, 9FDFF16BEAECF4E8
...
// reference: DBD770BE009B9820, 9FDFF16BEAECF4E8
// program: 2B811601C66B2B58, AD7922A63ED54CA7, 9FDFF16BEAECF4E8
// shader: 8B30, 2062FD1BEDC77F9F
...
vec3 color_output_3 = byteround(clamp((texcolor0.rrr) * (const_color[3].rrr) + (texcolor0.bbb) * (vec3(1.0) - (const_color[3].rrr)), vec3(0.0), vec3(1.0)));
float alpha_output_3 = byteround(clamp((texcolor0.a) * (texcolor1.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_3, alpha_output_3), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
next_combiner_buffer.a = last_tex_env_out.a;

vec3 color_output_4 = byteround(clamp((texcolor0.ggg) * (const_color[4].ggg) + (last_tex_env_out.rgb) * (vec3(1.0) - (const_color[4].ggg)), vec3(0.0), vec3(1.0)));
float alpha_output_4 = byteround(clamp((last_tex_env_out.a) * (rounded_primary_color.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_4, alpha_output_4), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_5 = byteround(clamp((texcolor0.rgb) * (const_color[5].aaa) + (last_tex_env_out.rgb) * (vec3(1.0) - (const_color[5].aaa)), vec3(0.0), vec3(1.0)));
float alpha_output_5 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_5, alpha_output_5), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 3C0D78944759E002, 2062FD1BEDC77F9F
// program: 4940142D60DA9543, 5D764F9A6220D694, 2062FD1BEDC77F9F
// shader: 8B30, 52B1EA5FEA6CD3CA
...
// reference: 924C06299DB9901E, 52B1EA5FEA6CD3CA
// program: 4940142D60DA9543, 5D764F9A6220D694, 52B1EA5FEA6CD3CA
// shader: 8B30, 6A02CACB7094520C
...
// reference: 2EA60C871C4686A4, 6A02CACB7094520C
// program: 4940142D60DA9543, 5D764F9A6220D694, 6A02CACB7094520C
// shader: 8B30, AB9EA4D8890D311F
...
// reference: 8E872F458CE7C8E0, AB9EA4D8890D311F
// program: 4940142D60DA9543, 5D764F9A6220D694, AB9EA4D8890D311F
// shader: 8B30, 1B37D512F692BF52
...
// reference: 1FF1043739F5CA7D, 1B37D512F692BF52
// program: 4940142D60DA9543, 5D764F9A6220D694, 1B37D512F692BF52
// shader: 8B30, C476772FBCEB0E9F
...
// reference: 3F41287AE8F91772, C476772FBCEB0E9F
// program: 4940142D60DA9543, 5D764F9A6220D694, C476772FBCEB0E9F
