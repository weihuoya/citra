...
bool sub_155_4096() {
    ...
    conditional_code.x = uniforms.f[95].xxxx.x < reg_tmp1.wwww.x;
    conditional_code.y = uniforms.f[95].xxxx.y == reg_tmp1.wwww.y;
...
// reference: 5511C26076EFA915, 524EDE0A1313B8ED
...
// reference: F1700612BE817A59, 14ABEA716B935289
// program: 524EDE0A1313B8ED, 2215DAB2EB8082F4, 14ABEA716B935289
// shader: 8B30, B7C12A0CD882AEBA
...
// reference: 7948407677B65AF7, B7C12A0CD882AEBA
// program: 524EDE0A1313B8ED, 2215DAB2EB8082F4, B7C12A0CD882AEBA
// reference: F1700612E7EDF7D8, 14ABEA716B935289
// reference: 1B453D20F51ACF67, 524EDE0A1313B8ED
// shader: 8B30, 114658BCB4D2699A
...
// reference: 2FC15C0D58022BFB, 114658BCB4D2699A
// program: 524EDE0A1313B8ED, 2215DAB2EB8082F4, 114658BCB4D2699A
// shader: 8B30, B960BBDBE65319E6
...
// reference: F17006120B5A1CDB, B960BBDBE65319E6
// program: 524EDE0A1313B8ED, 2215DAB2EB8082F4, B960BBDBE65319E6
// shader: 8B31, A91F38148A944C4F
...
bool sub_27_31() {
    reg_tmp0.x = dot_s(uniforms.f[20 + address_registers.x], reg_tmp14);
    reg_tmp0.y = dot_s(uniforms.f[21 + address_registers.x], reg_tmp14);
    reg_tmp0.z = dot_s(uniforms.f[22 + address_registers.x], reg_tmp14);
    reg_tmp15.xyz = (fma_s(reg_tmp0.xyzz, reg_tmp13.wwww, reg_tmp15.xyzz)).xyz;
    return false;
}
bool sub_31_35() {
    reg_tmp0.x = dot_3(uniforms.f[20 + address_registers.x].xyz, reg_tmp14.xyz);
    reg_tmp0.y = dot_3(uniforms.f[21 + address_registers.x].xyz, reg_tmp14.xyz);
    reg_tmp0.z = dot_3(uniforms.f[22 + address_registers.x].xyz, reg_tmp14.xyz);
    reg_tmp15.xyz = (fma_s(reg_tmp0.xyzz, reg_tmp13.wwww, reg_tmp15.xyzz)).xyz;
    return false;
}
bool sub_35_4096() {
    ...
    while (true) {
        switch (jmp_to) {
        case 35u: {
            conditional_code = equal(uniforms.f[95].xx, vs_in_reg3.xy);
            ...
            conditional_code = equal(uniforms.f[95].xx, vs_in_reg3.zw);
            if (conditional_code.x) {
                { jmp_to = 56u; break; }
            }
        ...
        case 56u: {
            ...
            conditional_code.x = uniforms.f[64].xyyy.x < reg_tmp0.yyyy.x;
            conditional_code.y = uniforms.f[64].xyyy.y > reg_tmp0.yyyy.y;
...
bool sub_74_80() {
    ...
    reg_tmp1.x = (max(uniforms.f[95].xxxx, reg_tmp1.xxxx)).x;
...
// reference: 7B6A576100382C5D, A91F38148A944C4F
// shader: 8DD9, 2EA4F51908E81B08
...
// reference: 83ABF08ECCF76B42, 2EA4F51908E81B08
// shader: 8B30, 085D419B501E2E4B
...
// reference: 2AC9D46777B65AF7, 085D419B501E2E4B
// program: A91F38148A944C4F, 2EA4F51908E81B08, 085D419B501E2E4B
// reference: 353EA82183CD4A2F, A91F38148A944C4F
// shader: 8B30, C47D99D7D91225F9
...
// reference: BD3C8AF824B3F99E, C47D99D7D91225F9
// program: 524EDE0A1313B8ED, 2215DAB2EB8082F4, C47D99D7D91225F9
// shader: 8B30, EAFF6DF44062C9E9
...
// reference: A2F19203E7EDF7D8, EAFF6DF44062C9E9
// program: 524EDE0A1313B8ED, 2215DAB2EB8082F4, EAFF6DF44062C9E9
// shader: 8B30, 1D4B6AAA9F5534A8
...
// reference: B83402921254EF14, 1D4B6AAA9F5534A8
// program: A91F38148A944C4F, 2EA4F51908E81B08, 1D4B6AAA9F5534A8
// shader: 8B31, C4B17896659C2ED0
...
bool sub_181_4096() {
    ...
    conditional_code.x = uniforms.f[95].xxxx.x <= reg_tmp2.wwww.x;
    conditional_code.y = uniforms.f[95].xxxx.y < reg_tmp2.wwww.y;
    if (conditional_code.x) {
        sub_192_198();
    }
...
// reference: 1B453D20E8AF2E35, C4B17896659C2ED0
// shader: 8B30, F026A6829C2D1B8D
...
// reference: 794840765FE6A4A0, F026A6829C2D1B8D
// program: C4B17896659C2ED0, 2215DAB2EB8082F4, F026A6829C2D1B8D
// program: A91F38148A944C4F, 2EA4F51908E81B08, B7C12A0CD882AEBA
// shader: 8B30, 744FA6057ADE9846
...
vec3 color_output_4 = byteround(clamp((last_tex_env_out.rgb) * (const_color[4].rrr) + (combiner_buffer.rgb) * (vec3(1.0) - (const_color[4].rrr)), vec3(0.0), vec3(1.0)));
...
// reference: 1FE0ED48FEEF9BD7, 744FA6057ADE9846
// program: A91F38148A944C4F, 2EA4F51908E81B08, 744FA6057ADE9846
// shader: 8B30, 79193226522198F9
...
// reference: A2F192030B5A1CDB, 79193226522198F9
// program: A91F38148A944C4F, 2EA4F51908E81B08, 79193226522198F9
