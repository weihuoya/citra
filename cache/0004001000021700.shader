...
// reference: 39E5C63AA1D269F8, 8B8A8119422860BE
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 8B8A8119422860BE
// shader: 8B30, 03D22A8F486202B8
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
vec3 color_output_5 = byteround(clamp((texcolor1.rgb) * (const_color[5].rgb) + (last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_5 = byteround(clamp(min((last_tex_env_out.a) + (texcolor1.a), 1.0) * (rounded_primary_color.a), 0.0, 1.0));
last_tex_env_out = vec4(color_output_5, alpha_output_5);
last_tex_env_out = clamp(last_tex_env_out, vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 9C48E24A6E7176EF, 03D22A8F486202B8
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 03D22A8F486202B8
// shader: 8B30, 940E1E69C733CD8B
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
// reference: 6F927EF5750002C8, 940E1E69C733CD8B
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 940E1E69C733CD8B
// shader: 8B30, D933996A92E6E147
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
// reference: 6F927EF53BF88BD2, D933996A92E6E147
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, D933996A92E6E147
// shader: 8B30, B34195702CC0ABF0
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
// reference: 76DFEC9F38DAB4F0, B34195702CC0ABF0
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, B34195702CC0ABF0
// shader: 8B30, B10B2FEB89939193
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
// reference: B9470860B925A24A, B10B2FEB89939193
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, B10B2FEB89939193
// shader: 8B30, F3271AD60D1B592B
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
// reference: 1221939706CDB8AC, F3271AD60D1B592B
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, F3271AD60D1B592B
// shader: 8B30, B8F8F7BD842EC9B4
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
// reference: F2449550C3ADEF80, B8F8F7BD842EC9B4
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, B8F8F7BD842EC9B4
// shader: 8B30, 734FC833A65C6CB5
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
// reference: B947086065B1EC08, 734FC833A65C6CB5
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 734FC833A65C6CB5
// shader: 8B30, 9105844D6ABA0A4D
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
// reference: 863692076318C2DD, 9105844D6ABA0A4D
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 9105844D6ABA0A4D
// shader: 8B30, 8CCF6D193CA578DD
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
// reference: 75EC0EB87869B6FA, 8CCF6D193CA578DD
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 8CCF6D193CA578DD
// shader: 8B30, 7DBC393D9EE3EC22
in vec4 primary_color;
in vec2 texcoord0;
in vec2 texcoord1;
in vec2 texcoord2;
...
// reference: 75EC0EB836913FE0, 7DBC393D9EE3EC22
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 7DBC393D9EE3EC22
// reference: D74AE6FF849BBD21, 47989A330044D8B4
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 47989A330044D8B4
// reference: 59EE128984CA6427, 52B23EB76EBD9526
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 52B23EB76EBD9526
// reference: 9676F6760535729D, FF212C0585AE36EC
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, FF212C0585AE36EC
// reference: D74AE6FFDE571C84, 51F2F7AF26D9CDF0
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 51F2F7AF26D9CDF0
// reference: CF64CE0687F1A3CE, 60C8D7C656E4BDFC
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 60C8D7C656E4BDFC
// reference: 59EE12898D139FED, 9430E12906D4655D
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 9430E12906D4655D
// reference: 9676F6760CEC8957, 22819C12B2395CA2
// program: FC7F4467554D34E5, 1C4CBC8096EA16CD, 22819C12B2395CA2
