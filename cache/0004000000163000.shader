...
bool sub_28_4096() {
    ...
    // 31: dp4
    reg_tmp15.w = dot(uniforms.f[95], vs_in_reg0);
    // 32: mul
...
// reference: 515A92D5DC4766EA, FB43F064EADA90EF
...
// reference: D4F4BEF91328FB4C, 4982B44D494E20C9
// program: FB43F064EADA90EF, 4E5317772B5CE683, 4982B44D494E20C9
// reference: C80FEA94DC4766EA, FB43F064EADA90EF
// shader: 8B31, D29BAA9319D92617
...
// reference: C80FEA948252A734, D29BAA9319D92617
...
// reference: CE312E68D672CA48, 29CEA8462618C993
// program: D29BAA9319D92617, 4E5317772B5CE683, 29CEA8462618C993
// reference: C80FEA9459EB0673, D29BAA9319D92617
// shader: 8B31, 99EA09986BD7E382
...
// reference: 24B5B7F5A9D50F61, 99EA09986BD7E382
...
// program: 99EA09986BD7E382, 8D9111E7F62CE874, 4982B44D494E20C9
// reference: 33A0B6BD0D444E42, FB43F064EADA90EF
// reference: AAF5CEFCD6FDEF05, FB43F064EADA90EF
// reference: AAF5CEFC88E82EDB, D29BAA9319D92617
// reference: EE3AA5CB6ECC0A8F, 99EA09986BD7E382
// reference: D4F4BEF912EA917B, 4982B44D494E20C9
// reference: F92FA483CA5D4BAC, FB43F064EADA90EF
// reference: 607ADCC211E4EAEB, FB43F064EADA90EF
// reference: 607ADCC24FF12B35, D29BAA9319D92617
// reference: CE312E68D7B0A07F, 29CEA8462618C993
// reference: FA7C30F2D8A7A374, D29BAA9319D92617
// reference: 632948B35D0BC3ED, FB43F064EADA90EF
// reference: FA7C30F286B262AA, FB43F064EADA90EF
// shader: 8B31, BC51156DFEDBC634
...
bool sub_74_79() {
    ...
    // 75: dp4
    reg_tmp11.x = dot(uniforms.f[32 + address_registers.y].wzyx, reg_tmp12);
    // 76: dp4
    reg_tmp11.y = dot(uniforms.f[33 + address_registers.y].wzyx, reg_tmp12);
    // 77: mul
    reg_tmp11.xy = (mul_safe(reg_tmp11.xyyy, reg_tmp14.zwww)).xy;
    // 78: add
    reg_tmp11.y = (uniforms.f[5].yyyy + -reg_tmp11.yyyy).y;
...
bool sub_93_95() {
    // 93: dp4
    reg_tmp11.x = dot(uniforms.f[32 + address_registers.y].wzyx, reg_tmp1);
    // 94: dp4
    reg_tmp11.y = dot(uniforms.f[33 + address_registers.y].wzyx, reg_tmp1);
    return false;
}
bool sub_97_109() {
    uint jmp_to = 97u;
    while (true) {
        ...
        case 97u: {
            // 97: dp4
            reg_tmp3.x = dot(uniforms.f[32 + address_registers.x].wzyx, reg_tmp1);
            // 98: dp4
            reg_tmp3.y = dot(uniforms.f[33 + address_registers.x].wzyx, reg_tmp1);
            // 99: dp4
            reg_tmp3.z = dot(uniforms.f[34 + address_registers.x].wzyx, reg_tmp1);
            // 100: mov
            ...
            // 105: rcp
            reg_tmp11.z = rcp_safe(reg_tmp11.zzzz.x);
            // 106: add
            reg_tmp3.x = (reg_tmp3.xxxx + reg_tmp11.xxxx).x;
            // 107: mad
            reg_tmp3.x = (fma_safe(-reg_tmp11.yyyy, reg_tmp11.zzzz, reg_tmp3.xxxx)).x;
        }
        case 108u: {
            // 108: nop
        }
...
bool sub_109_4096() {
    ...
    while (true) {
        ...
        case 191u: {
            ...
            // 193: mul
            reg_tmp13.xy = (mul_safe(uniforms.f[36 + address_registers.x].wzzz, reg_tmp2.xyyy)).xy;
            // 194: mul
            reg_tmp11.x = (mul_safe(uniforms.f[35 + address_registers.x].wwww, -reg_tmp1.yyyy)).x;
            // 195: mul
            reg_tmp1.xy = (mul_safe(reg_tmp1.xyyy, reg_tmp13.xyyy)).xy;
            // 196: add
...
bool sub_198_207() {
    // 198: mul
    reg_tmp13.xzw = (mul_safe(uniforms.f[5].wxxx, reg_tmp13.xxxx)).xzw;
    // 199: mul
    reg_tmp13.y = (mul_safe(uniforms.f[34 + address_registers.y].yyyy, reg_tmp13.yyyy)).y;
    // 200: mad
    reg_tmp11 = fma_safe(reg_tmp1, uniforms.f[5].yyxx, -reg_tmp13);
    // 201: mov
    reg_tmp14 = uniforms.f[33 + address_registers.y].wzyx;
    // 202: dp3
    reg_tmp1.x = dot(vec3(reg_tmp11), vec3(reg_tmp14.xyyy));
    // 203: dp3
    reg_tmp1.y = dot(vec3(reg_tmp11), vec3(reg_tmp14.zwww));
    // 204: mov
    reg_tmp14 = uniforms.f[34 + address_registers.y].wzyx;
    // 205: dph
    reg_tmp1.z = dot(reg_tmp11, reg_tmp14);
    // 206: add
...
bool sub_215_223() {
    ...
    // 219: mul
    reg_tmp14.w = (mul_safe(uniforms.f[5].zzzz, reg_tmp14.wwww)).w;
    // 220: mov
    reg_tmp14.xyz = (uniforms.f[5].yyyy).xyz;
    // 221: mul
    reg_tmp7 = mul_safe(uniforms.f[37 + address_registers.y].wzyx, reg_tmp14);
    // 222: mul
    reg_tmp8 = mul_safe(uniforms.f[38 + address_registers.y].wzyx, reg_tmp14);
    return false;
}
bool sub_223_227() {
    // 223: max
...
// reference: BFE369B66225DFD3, BC51156DFEDBC634
...
// program: BC51156DFEDBC634, 5D764F9A6220D694, ECB67079092E1152
// shader: 8B31, D11E768CCC071E29
...
bool sub_7_12() {
    ...
    // 11: mad
    reg_tmp10 = fma_safe(reg_tmp1.wwww, reg_tmp3, reg_tmp10);
    return false;
}
bool sub_12_21() {
    // 12: mova
...
bool sub_131_137() {
    ...
    address_registers.x = (ivec2(reg_tmp1.xxxx)).x;
    // 133: dp4
    reg_tmp10.x = dot(uniforms.f[25 + address_registers.x], reg_tmp15);
    // 134: dp4
    reg_tmp10.y = dot(uniforms.f[26 + address_registers.x], reg_tmp15);
    // 135: dp4
    reg_tmp10.z = dot(uniforms.f[27 + address_registers.x], reg_tmp15);
    // 136: mov
    reg_tmp10.w = (uniforms.f[93].yyyy).w;
    return false;
}
...
// reference: 3F464D49997813E3, D11E768CCC071E29
...
// reference: 341790063E76288A, C4DEE93C4FFD8895
// program: D11E768CCC071E29, AD7922A63ED54CA7, C4DEE93C4FFD8895
// shader: 8B30, 1CEBFD45F0A3560C
...
// reference: D4F4BEF903F8A64D, 1CEBFD45F0A3560C
// program: D11E768CCC071E29, AD7922A63ED54CA7, 1CEBFD45F0A3560C
// shader: 8B30, 477705F03334186C
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp((texcolor0.rgb) * (rounded_primary_color.rgb) + (secondary_fragment_color.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp((rounded_primary_color.a) * (texcolor0.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_0, alpha_output_0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 746127E23B1B9A32, 477705F03334186C
// program: D11E768CCC071E29, AD7922A63ED54CA7, 477705F03334186C
// shader: 8B30, BCBEC8533D8BD722
...
// reference: 667B7B2502092470, BCBEC8533D8BD722
// program: D11E768CCC071E29, AD7922A63ED54CA7, BCBEC8533D8BD722
// shader: 8B30, 6F8B5532B8247271
...
// reference: 0A2711236DDC3DD8, 6F8B5532B8247271
// program: D11E768CCC071E29, AD7922A63ED54CA7, 6F8B5532B8247271
// shader: 8B30, 3CE84F369318002E
...
// reference: F0635A881F0B8A8A, 3CE84F369318002E
// program: D11E768CCC071E29, AD7922A63ED54CA7, 3CE84F369318002E
// shader: 8B30, 4694ADA3D4BA4782
...
// reference: A0D030541F0B8A8A, 4694ADA3D4BA4782
// program: D11E768CCC071E29, AD7922A63ED54CA7, 4694ADA3D4BA4782
// shader: 8B30, EA439636AA691A1D
...
// reference: A9A63BDFE5CB2C30, EA439636AA691A1D
// program: D11E768CCC071E29, AD7922A63ED54CA7, EA439636AA691A1D
// reference: 2A72054AA55D6393, FB43F064EADA90EF
// reference: 77B68CE8DD625223, 4982B44D494E20C9
// reference: 88579F05C3396140, BC51156DFEDBC634
// reference: CDC8C64179BB1DE7, D29BAA9319D92617
// reference: D98E5378CFD0B41C, 99EA09986BD7E382
// reference: CE9B52306B41F53F, FB43F064EADA90EF
// shader: 8B30, 6DC1DC2558EFAA62
...
// reference: A845CC983BAD9170, 6DC1DC2558EFAA62
// program: BC51156DFEDBC634, 5D764F9A6220D694, 6DC1DC2558EFAA62
// reference: 549DBE00FC177D7E, FB43F064EADA90EF
...
// program: BC51156DFEDBC634, 5D764F9A6220D694, A7554B42F30AEAE4
// reference: 2A72054AFB48A24D, D29BAA9319D92617
// reference: FE5492A2E506BABA, 99EA09986BD7E382
// reference: E94193EA4197FB99, FB43F064EADA90EF
// reference: 7014EBAB9A2E5ADE, FB43F064EADA90EF
// reference: 7014EBABC43B9B00, D29BAA9319D92617
// shader: 8B30, 3F4DCCB8CB880E89
...
// reference: DCEB09428F9A79EC, 3F4DCCB8CB880E89
// program: D11E768CCC071E29, AD7922A63ED54CA7, 3F4DCCB8CB880E89
// reference: DCEB09429A9B5D85, 4982B44D494E20C9
// shader: 8B30, B0C51F9DAFAF27A2
...
// reference: 0F8839B152228419, B0C51F9DAFAF27A2
// program: D11E768CCC071E29, AD7922A63ED54CA7, B0C51F9DAFAF27A2
// shader: 8B30, 4C1D73575A876955
...
// reference: 381FFC443161FF5F, 4C1D73575A876955
// program: D11E768CCC071E29, AD7922A63ED54CA7, 4C1D73575A876955
// shader: 8B30, CFAA4C91523C4942
...
// reference: ABE1439A523FAA1C, CFAA4C91523C4942
// program: D11E768CCC071E29, AD7922A63ED54CA7, CFAA4C91523C4942
// shader: 8B30, 177008421E3518FE
...
// reference: 80E07088FE4CD579, 177008421E3518FE
// program: D11E768CCC071E29, AD7922A63ED54CA7, 177008421E3518FE
// shader: 8B30, BDF1E6AFED704B28
...
// reference: D4F4BEF959D7EB60, BDF1E6AFED704B28
// program: D11E768CCC071E29, AD7922A63ED54CA7, BDF1E6AFED704B28
// shader: 8B30, 83389E3205243E6F
...
// reference: 36B4CD7F9BAB382E, 83389E3205243E6F
// program: D11E768CCC071E29, AD7922A63ED54CA7, 83389E3205243E6F
// reference: 0F8839B16A2E5C2B, B0C51F9DAFAF27A2
...
// reference: D4F4BEF90F2B6A94, 47C12CB4EFB88BF9
// program: D11E768CCC071E29, AD7922A63ED54CA7, 47C12CB4EFB88BF9
// shader: 8B30, B3EBADF433E26BB6
...
// reference: DDCB461EDC523788, B3EBADF433E26BB6
// program: D11E768CCC071E29, AD7922A63ED54CA7, B3EBADF433E26BB6
// shader: 8B30, 965C514BCE065365
...
// reference: D36077257698F0F9, 965C514BCE065365
// program: D11E768CCC071E29, AD7922A63ED54CA7, 965C514BCE065365
// shader: 8B30, FB3EB59E3BD6DEC1
...
// reference: 6B9FFBE9B9B5DADF, FB3EB59E3BD6DEC1
// program: D11E768CCC071E29, AD7922A63ED54CA7, FB3EB59E3BD6DEC1
// shader: 8B30, 3FB61AA84BDA8F4B
...
// reference: C892FAE2B732BFA0, 3FB61AA84BDA8F4B
// program: D11E768CCC071E29, AD7922A63ED54CA7, 3FB61AA84BDA8F4B
// shader: 8B30, 0E4CCBAAB1BC4860
...
// reference: 37948223965F2838, 0E4CCBAAB1BC4860
// program: D11E768CCC071E29, AD7922A63ED54CA7, 0E4CCBAAB1BC4860
// shader: 8B30, E462CA9823594938
...
refl_value.b = refl_value.r;
diffuse_sum.rgb += ((light_src[0].diffuse * dot_product) + light_src[0].ambient) * 1.0;
specular_sum.rgb += (((lut_scale_d0 * LookupLightingLUTUnsigned(0, abs(dot(normal, normalize(half_vector))))) * light_src[0].specular_0) + (light_src[0].specular_1)) * clamp_highlights * 1.0;
diffuse_sum.rgb += lighting_global_ambient;
primary_fragment_color = clamp(diffuse_sum, vec4(0.0), vec4(1.0));
secondary_fragment_color = clamp(specular_sum, vec4(0.0), vec4(1.0));
...
// reference: E4F7B2D0B91387FF, E462CA9823594938
// program: D11E768CCC071E29, AD7922A63ED54CA7, E462CA9823594938
// shader: 8B30, 17632122A5BA293E
...
// reference: 409EC8FB15C6A5BA, 17632122A5BA293E
// program: D11E768CCC071E29, AD7922A63ED54CA7, 17632122A5BA293E
// reference: 783505D7C145CA36, 4982B44D494E20C9
// shader: 8B30, EA23E8220D1880E4
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp((texcolor2.rgb) * (texture(tex_cube, vec3(texcoord0, texcoord0_w)).rgb), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp((rounded_primary_color.a) * (const_color[0].a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_0, alpha_output_0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_1 = byteround(clamp(min((last_tex_env_out.rgb) + (const_color[1].aaa), vec3(1.0)) * (texcolor1.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_1 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_1, alpha_output_1), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
vec3 color_output_3 = byteround(clamp((last_tex_env_out.rgb) * (primary_fragment_color.rgb) + (secondary_fragment_color.rgb), vec3(0.0), vec3(1.0)));
...
// reference: 8274FBA715EB702B, EA23E8220D1880E4
// program: D11E768CCC071E29, AD7922A63ED54CA7, EA23E8220D1880E4
// shader: 8B30, 7161C5C4B42F826E
...
// reference: C737C7CBCB53C289, 7161C5C4B42F826E
// program: D11E768CCC071E29, AD7922A63ED54CA7, 7161C5C4B42F826E
// shader: 8B30, E2D84179D67301B9
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp(min((texcolor0.rgb) + (const_color[0].aaa), vec3(1.0)) * (texcolor1.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp((rounded_primary_color.a) * (texcolor0.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_0, alpha_output_0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 6198A39D29FF7FA9, E2D84179D67301B9
// program: D11E768CCC071E29, AD7922A63ED54CA7, E2D84179D67301B9
// shader: 8B30, 4707BD14605C49B5
...
// reference: 054EB0BF8D748F94, 4707BD14605C49B5
// program: D11E768CCC071E29, AD7922A63ED54CA7, 4707BD14605C49B5
// shader: 8B30, D8BC1B6B67C1E6A4
...
vec3 color_output_3 = byteround(clamp(min((last_tex_env_out.rgb) + (texcolor0.rgb), vec3(1.0)) * (const_color[3].rgb), vec3(0.0), vec3(1.0)));
float alpha_output_3 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_3, alpha_output_3), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 5C831B5E6E7E41FF, D8BC1B6B67C1E6A4
// program: D11E768CCC071E29, AD7922A63ED54CA7, D8BC1B6B67C1E6A4
// shader: 8B30, B731E0D69023EDA4
...
// reference: E06237D5E33502C7, B731E0D69023EDA4
// program: D11E768CCC071E29, AD7922A63ED54CA7, B731E0D69023EDA4
// shader: 8B30, 40D3C839133897CC
...
vec3 color_output_2 = byteround(clamp((last_tex_env_out.rgb) * (const_color[2].rgb) + (texcolor1.rgb) * (vec3(1.0) - (const_color[2].rgb)), vec3(0.0), vec3(1.0)));
float alpha_output_2 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_2, alpha_output_2), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 50E14E134DB9F58F, 40D3C839133897CC
// program: D11E768CCC071E29, AD7922A63ED54CA7, 40D3C839133897CC
// shader: 8B30, BC13A38B90D2D402
...
vec3 color_output_1 = byteround(clamp(min((const_color[1].aaa) + (rounded_primary_color.rgb), vec3(1.0)) * (last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_1 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_1, alpha_output_1), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 792EA99644908663, BC13A38B90D2D402
// program: D11E768CCC071E29, AD7922A63ED54CA7, BC13A38B90D2D402
// shader: 8B30, 395F580D79F2B5A8
...
vec3 color_output_3 = byteround(clamp(min((const_color[3].rgb) + (texcolor0.rgb), vec3(1.0)) * (last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_3 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_3, alpha_output_3), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 2E517FC4B1B88BC0, 395F580D79F2B5A8
// program: D11E768CCC071E29, AD7922A63ED54CA7, 395F580D79F2B5A8
// shader: 8B30, 509B99D2F02F4CD3
...
half_vector = normalize(view) + light_vector;
dot_product = abs(dot(light_vector, normal));
refl_value.r = (lut_scale_rr * LookupLightingLUTUnsigned(6, abs(dot(normal, normalize(view)))));
refl_value.g = refl_value.r;
refl_value.b = refl_value.r;
diffuse_sum.rgb += ((light_src[0].diffuse * dot_product) + light_src[0].ambient) * 1.0;
specular_sum.rgb += (((lut_scale_d0 * LookupLightingLUTUnsigned(0, abs(dot(normal, normalize(view))))) * light_src[0].specular_0) + (refl_value * light_src[0].specular_1)) * clamp_highlights * 1.0;
diffuse_sum.rgb += lighting_global_ambient;
primary_fragment_color = clamp(diffuse_sum, vec4(0.0), vec4(1.0));
secondary_fragment_color = clamp(specular_sum, vec4(0.0), vec4(1.0));
...
// reference: 47E3068F013638F5, 509B99D2F02F4CD3
// program: D11E768CCC071E29, AD7922A63ED54CA7, 509B99D2F02F4CD3
// shader: 8B30, C888DE6AB919D6EE
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp((texcolor1.aaa) * (texture(tex_cube, vec3(texcoord0, texcoord0_w)).rgb), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_0, alpha_output_0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
vec3 color_output_2 = byteround(clamp(min((last_tex_env_out.rgb) + (const_color[2].aaa), vec3(1.0)) * (texcolor1.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_2 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_2, alpha_output_2), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_3 = byteround(clamp((const_color[3].rgb) * (texcolor2.rgb) + (last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_3 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_3, alpha_output_3), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_4 = byteround(clamp((last_tex_env_out.rgb) * (primary_fragment_color.rgb) + (secondary_fragment_color.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_4 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_4, alpha_output_4), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: D5A39F4654BFC8BF, C888DE6AB919D6EE
// program: D11E768CCC071E29, AD7922A63ED54CA7, C888DE6AB919D6EE
// shader: 8B30, 5330BFA4197ED10A
...
// reference: 36B4CD7F7FD47B6A, 5330BFA4197ED10A
// program: D11E768CCC071E29, AD7922A63ED54CA7, 5330BFA4197ED10A
// shader: 8B30, 30AF6D8AF56F2BC8
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp((const_color[0].aaa) * (texcolor1.rgb) + (texcolor0.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp((rounded_primary_color.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_0, alpha_output_0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 7D465C552D2441F4, 30AF6D8AF56F2BC8
// program: D11E768CCC071E29, AD7922A63ED54CA7, 30AF6D8AF56F2BC8
// shader: 8B30, 91B639472118B65F
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp((const_color[0].rgb) * (texcolor1.rgb) + (texcolor0.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp((rounded_primary_color.a) * (texcolor0.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_0, alpha_output_0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
vec3 color_output_2 = byteround(clamp((last_tex_env_out.rgb) * (rounded_primary_color.rgb) + (secondary_fragment_color.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_2 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_2, alpha_output_2), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 90066158E48CC4D4, 91B639472118B65F
// program: D11E768CCC071E29, AD7922A63ED54CA7, 91B639472118B65F
// shader: 8B30, F9B3D6CF63BC6F86
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp(min((texcolor1.rgb) + (const_color[0].rgb), vec3(1.0)) * (texcolor0.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp((rounded_primary_color.a) * (texcolor0.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_0, alpha_output_0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: FAA7A7449D5785CD, F9B3D6CF63BC6F86
// program: D11E768CCC071E29, AD7922A63ED54CA7, F9B3D6CF63BC6F86
// reference: 53DE24D79A9B5D85, 4982B44D494E20C9
// shader: 8B30, E38374FDAD0D2DE8
...
vec4 next_combiner_buffer = tev_combiner_buffer_color;
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp((const_color[0].rgb) * (vec3(1.0) - texcolor1.rgb) + (texcolor0.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp((rounded_primary_color.a) * (texcolor0.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_0, alpha_output_0), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;

vec3 color_output_1 = byteround(clamp(min((const_color[1].rgb) + (rounded_primary_color.rgb), vec3(1.0)) * (last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_1 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_1, alpha_output_1), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 1482AF1B058A8D4E, E38374FDAD0D2DE8
// program: D11E768CCC071E29, AD7922A63ED54CA7, E38374FDAD0D2DE8
...
// reference: D4F4BEF9D9BFE034, 7BD362BEDDE071ED
// program: D11E768CCC071E29, AD7922A63ED54CA7, 7BD362BEDDE071ED
// shader: 8B30, B1F186610FB90FD0
...
// reference: 3C8F6E7B8A98931C, B1F186610FB90FD0
// program: D11E768CCC071E29, AD7922A63ED54CA7, B1F186610FB90FD0
// shader: 8B30, 8157A19FF322AF85
...
// reference: 0D4BCDF8D43EC2B3, 8157A19FF322AF85
// program: D11E768CCC071E29, AD7922A63ED54CA7, 8157A19FF322AF85
// shader: 8B30, 57DE8B470527AC0F
...
// reference: 10807477E96850A3, 57DE8B470527AC0F
// program: D11E768CCC071E29, AD7922A63ED54CA7, 57DE8B470527AC0F
// shader: 8B30, 09C49B4B75D715AE
...
// reference: E44CA1B2E96850A3, 09C49B4B75D715AE
// program: D11E768CCC071E29, AD7922A63ED54CA7, 09C49B4B75D715AE
...
// reference: 0A45E4E6E0FD2A0E, AC6AB3727504551A
// program: D11E768CCC071E29, AD7922A63ED54CA7, AC6AB3727504551A
// shader: 8B30, 845CE5098BA9EF55
...
// reference: 0A45E4E643A974D4, 845CE5098BA9EF55
// program: D11E768CCC071E29, AD7922A63ED54CA7, 845CE5098BA9EF55
// reference: D4F4BEF9864F9AE1, 4982B44D494E20C9
// program: D11E768CCC071E29, AD7922A63ED54CA7, 4982B44D494E20C9
// shader: 8B30, 1634ECDD7B1C2517
...
vec4 last_tex_env_out = vec4(0.0);
vec3 color_output_0 = byteround(clamp((const_color[0].rgb), vec3(0.0), vec3(1.0)));
float alpha_output_0 = byteround(clamp(min((rounded_primary_color.r) + (texcolor0.r), 1.0) * (rounded_primary_color.a), 0.0, 1.0));
...
// reference: AEF3D2F0D45BA536, 1634ECDD7B1C2517
// program: D11E768CCC071E29, AD7922A63ED54CA7, 1634ECDD7B1C2517
// reference: 025A535DCB53C289, 7161C5C4B42F826E
// reference: B3277D0B7EE4C2D4, FB43F064EADA90EF
// shader: 8B30, B047C4CB503B013A
...
vec3 color_output_1 = byteround(clamp((const_color[1].rgb) * (texture(tex_cube, vec3(texcoord0, texcoord0_w)).rgb) + (last_tex_env_out.rgb), vec3(0.0), vec3(1.0)));
float alpha_output_1 = byteround(clamp((last_tex_env_out.a), 0.0, 1.0));
last_tex_env_out = clamp(vec4(color_output_1, alpha_output_1), vec4(0.0), vec4(1.0));
combiner_buffer = next_combiner_buffer;
...
// reference: 1391827794F4BFFE, B047C4CB503B013A
// program: D11E768CCC071E29, AD7922A63ED54CA7, B047C4CB503B013A
// reference: 19869DD48F9A79EC, 3F4DCCB8CB880E89
// shader: 8B30, 5E85234A7A464FF4
...
// reference: 2D5112B21FFCF145, 5E85234A7A464FF4
// program: D11E768CCC071E29, AD7922A63ED54CA7, 5E85234A7A464FF4
// reference: 21213524E96850A3, 09C49B4B75D715AE
// reference: 11992A6F0F2B6A94, 47C12CB4EFB88BF9
// reference: 11992A6F12EA917B, 4982B44D494E20C9
// shader: 8B30, FB50F0B3C506F3CB
...
// reference: E91E9331D1E6D337, FB50F0B3C506F3CB
// program: BC51156DFEDBC634, 5D764F9A6220D694, FB50F0B3C506F3CB
